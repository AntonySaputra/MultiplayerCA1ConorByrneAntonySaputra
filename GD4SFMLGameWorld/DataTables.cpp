...
std::vector<PlayerData> initializePlayerData()
{
	...
	data[static_cast<int>(PlayerID::Player1)].categoryID = CategoryID::PlayerAircraft1;
	...
	data[static_cast<int>(PlayerID::Player2)].categoryID = CategoryID::PlayerAircraft2;
...
std::vector<AircraftData> initializeAircraftData()
{
	...
	data[static_cast<int>(AircraftID::Eagle1)].hitpoints = 100;
	data[static_cast<int>(AircraftID::Eagle1)].speed = 200.f;
	data[static_cast<int>(AircraftID::Eagle1)].fireInterval = sf::seconds(1);
	data[static_cast<int>(AircraftID::Eagle1)].textureRect = sf::IntRect(0, 0, 48, 64);
	data[static_cast<int>(AircraftID::Eagle1)].texture = TextureID::Entities;
	data[static_cast<int>(AircraftID::Eagle1)].hasRollAnimation = true;
